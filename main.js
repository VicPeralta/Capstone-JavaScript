...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nasync function makeRequest(url, method = 'GET', Body = '') {\n  try {\n    const options = {\n      method: `${method}`,\n      headers: {\n        'Content-Type': 'application/json',\n        Accept: 'application/json',\n      },\n      mode: 'cors',\n      cache: 'no-cache',\n      credentials: 'same-origin',\n    };\n    if (Body !== '') options.body = Body;\n    const results = await fetch(url, options).then((data) => data.json());\n    return results;\n  } catch {\n    return [];\n  }\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (makeRequest);\n\n//# sourceURL=webpack://capstoneprojectjavascript/./src/utils.js?");

/***/ }),

/***/ "./src/assets/tunes4.png":
/*!*******************************!*\
  !*** ./src/assets/tunes4.png ***!
  \*******************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"808853c51229c1c8e220.png\";\n\n//# sourceURL=webpack://capstoneprojectjavascript/./src/assets/tunes4.png?");
